...
public class BuilderHelper {
    public static void trigorathBuilder(Point2D.Double p1, Point2D.Double p2) {
        ...
        Point2D.Double center = new Point2D.Double((((2 / 3) * vastKhat.x) + ((1 / 3) * X1)), (((2 / 3) * vastKhat.y) + ((1 / 3) * Y1)));
    ...
    public static void squarantineBuilder(Point2D.Double p1, Point2D.Double p2) {
        ...
        new SquarantineModel(getCenter(XPoint, YPoint),SQUAER_COLOR, XPoint, YPoint);
    }
