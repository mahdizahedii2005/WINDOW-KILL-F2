...
public class constants {
    ...
    public static double SPEED = 3 * 40D / UPS;
    ...
    public static double RANGE_OF_INCREASE_SIZE = 30;
    public static double RANGE_OF_INCREASE_PLACE = RANGE_OF_INCREASE_SIZE;
    public static double RANGE_OF_DECREASE_PLACE = RANGE_OF_INCREASE_SIZE / 12;
    public static double MOVE_RANGE = RANGE_OF_INCREASE_PLACE / 8;
    public static double DECREASE_OF_PANEL = 2;
    public static final double IMPACT_POWER = 60;
    public static int DELAY_OF_CLOSE_FRAME = 12;
